...
def main(train_file, eval_file, target_lang, num_train_records):
    source_train_file = train_file.rsplit('.', 1)[0] + '.en' # replace the file type of the target file w/ 'en'
    ...
    output_directory = os.path.join(home, 'chicago2/models/fine_tuned_models')
    model_output_name = f"llama-3-8B-{target_lang}-{num_train_records}"
...
if __name__ == "__main__":
    ...
    main(args.train_file, args.eval_file, args.target_lang, args.num_train_records)

# python3 trainer.py --train_file "practicum/data/train_dataset.pt-br" --eval_file "practicum/data/train_dataset.pt-br" --target_lang "Brazilian Portuguese" --num_train_records 100